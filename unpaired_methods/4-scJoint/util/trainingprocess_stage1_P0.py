...
from util.dataloader_stage1_P0 import PrepareDataloader
...
class TrainingProcessStage1():
    ...
    def write_embeddings(self):
        ...
        if not os.path.exists("/home/xcx/results/P0/4-scJoint/"):
            os.makedirs("/home/xcx/results/P0/4-scJoint/")
        
        # rna db
        for i, rna_loader in enumerate(self.test_rna_loaders):
            db_name = os.path.basename(self.config.rna_paths[i]).split('.')[0]
            fp_em = open('/home/xcx/results/P0/4-scJoint/' + db_name + '_embeddings.txt', 'w')
            fp_pre = open('/home/xcx/results/P0/4-scJoint/' + db_name + '_predictions.txt', 'w')
