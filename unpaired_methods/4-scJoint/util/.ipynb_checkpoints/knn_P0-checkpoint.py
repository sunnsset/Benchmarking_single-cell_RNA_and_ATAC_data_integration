...
def KNN(config, neighbors = 30, knn_rna_samples = 20000):    
    ...
    rna_embeddings = np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_embeddings.txt')
    rna_predictions = np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_predictions.txt')
    ...
    for i in range(1, len(config.rna_paths)):
        ...
        rna_embeddings = np.concatenate((rna_embeddings, np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_embeddings.txt')), 0)
        rna_predictions = np.concatenate((rna_predictions, np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_predictions.txt')), 0)
    ...
    atac_embeddings = np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_embeddings.txt')
    atac_predictions = np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_predictions.txt')
    ...
    for i in range(1, len(config.atac_paths)):
        ...
        em = np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_embeddings.txt')
        pred = np.loadtxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_predictions.txt')
    ...
    for i, db_name in enumerate(db_names):        
        np.savetxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_knn_predictions.txt', atac_predict[cnt:cnt+db_sizes[i]])
        np.savetxt('/home/xcx/results/P0/4-scJoint/' + db_name + '_knn_probs.txt', conf_scores[cnt:cnt+db_sizes[i]])
        cnt += db_sizes[i]
